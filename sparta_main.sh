...
## chmod +x  run_abundance_to_score_v6.sh
##./run_abundance_to_score_v6.sh -d abundance_whatever -t tf_igm -s relative -i 2
...
while getopts "d:t:s:i:e:" arg; do
    case $arg in
...
if [ $dataset_name == "" ]
	...
	then
		...
		#	fi
		#
		#cp "$PWD/SoFA_calculation/outputs/$dataset_name/entree_DeepMicro_${dataset_name}.csv" "$PWD/DeepMicro/data"
		#cp "$PWD/SoFA_calculation/outputs/$dataset_name/entree_DeepMicro_${dataset_name}_test.csv" "$PWD/DeepMicro/data"
		#cp "$PWD/SoFA_calculation/outputs/$dataset_name/entree_DeepMicro_${dataset_name}_OTU.csv" "$PWD/DeepMicro/data"
		#cp "$PWD/SoFA_calculation/outputs/$dataset_name/entree_DeepMicro_${dataset_name}_OTU_test.csv" "$PWD/DeepMicro/data"
		...
		if [ "$treatment" == "tf_igm" ]
			then
				python DMmodif_export_test_ver.py -r 3 -cd entree_DeepMicro_${dataset_name}_tfigm.csv -cl Label_$dataset_name.csv -m rf 
				python test_set_measurement.py -d "${dataset_name}" -p "$path" -r "$data_ref" -i "1" --tfigm
				
		elif [ "$treatment" == "scaling" ]
			then
				python DMmodif_export_test_ver.py -r 3 -cd entree_DeepMicro_${dataset_name}_scaled.csv -cl Label_$dataset_name.csv -m rf 
				python test_set_measurement.py -d "${dataset_name}" -p "$path" -r "$data_ref" -i "1" --scaling
		else
				python DMmodif_export_test_ver.py -r 3 -cd entree_DeepMicro_${dataset_name}.csv -cl Label_$dataset_name.csv -m rf 
				python test_set_measurement.py  -d"${dataset_name}" -p "$path" -r "$data_ref" -i "1"
			fi
		
	
		
		python DMmodif_export_test_ver.py -r 3 -cd entree_DeepMicro_${dataset_name}_OTU.csv -cl Label_$dataset_name.csv -m rf 
		...
		do
			...
			if [ "$treatment" == "tf_igm" ]
				then
					python DMmodif_export_test_ver.py -r 3 -cd entree_DeepMicro_${dataset_name}_iteration_${it}_tfigm.csv -cl Label_$dataset_name.csv -m rf 
					python test_set_measurement.py -d "${dataset_name}_iteration_${it}" -p "$path" -r "$data_ref" -i "$it" --tfigm
			elif [ "$treatment" == "scaling" ]
				then
					python DMmodif_export_test_ver.py -r 3 -cd entree_DeepMicro_${dataset_name}_iteration_${it}_scaled.csv -cl Label_$dataset_name.csv -m rf 
					python test_set_measurement.py -d "${dataset_name}_iteration_${it}" -p "$path" -r "$data_ref" -i "$it" --scaling
			else
					python DMmodif_export_test_ver.py -r 3 -cd entree_DeepMicro_${dataset_name}_iteration_${it}.csv -cl Label_$dataset_name.csv -m rf 
					python test_set_measurement.py -d "${dataset_name}_iteration_${it}" -p "$path" -r "$data_ref" -i "$it"
				fi
				
			python DMmodif_export_test_ver.py -r 3 -cd entree_DeepMicro_${dataset_name}_iteration_${it}_OTU.csv -cl Label_$dataset_name.csv -m rf 
