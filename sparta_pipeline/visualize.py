...
def plot_classifs(bank_of_performance_dfs_annots, bank_of_performance_dfs_taxons, dataset_name, output_file, output_file_v2, otu_abundance_filepath=None):
    '''
    ...
    return((best_selec_iter_annots_v1, best_selec_iter_annots_v2), (best_selec_iter_taxons_v1, best_selec_iter_taxons_v2))