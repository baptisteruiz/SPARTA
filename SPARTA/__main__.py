...
def main():
    ...
    parent_parser_seed.add_argument("--seed", default=0, help="Master seed that will define the randomness of the training/validation/test sets (used for reproducibility).")
